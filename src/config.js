export default {
	...
	OPEN_DATA_HUB_ONLY_SHOW_MAP: 'https://mobility.api.opendatahub.bz.it/v2/flat/NOI-Place?limit=-1&offset=0&select=sname,smetadata&where=smetadata.show_on_map.eq.1&shownull=true&distinct=true',
	OPEN_DATA_HUB_TYPES_GROUPS: 'https://mobility.api.opendatahub.bz.it/v2/flat/NOI-Place/*/latest?limit=-1&offset=0&select=tmetadata,mvalue&shownull=false&distinct=true',
