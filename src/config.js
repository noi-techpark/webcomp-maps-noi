export default {
  OPEN_DATA_HUB_RESOURCE_URL: process.env.ODH_RESOURCE_URL,
	...
	OPEN_DATA_HUB_TYPES: process.env.ODH_BASE_URL+'/*/latest?limit=-1&offset=0&select=tmetadata,mvalue&shownull=false&distinct=true&where=mvalue.eq.Selettori%20Type,sorigin.eq.office365',
	OPEN_DATA_HUB_TYPES_GROUPS: process.env.ODH_BASE_URL+'/*/latest?limit=-1&offset=0&select=tmetadata,mvalue&shownull=false&distinct=true&where=mvalue.eq.Selettori%20Group,sorigin.eq.office365',
